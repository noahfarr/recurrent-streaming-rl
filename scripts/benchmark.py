...
COMBOS = [
    ...
    ("gru", "bptt", 256, 8192),
    ("gru", "bptt", 512, 8192),
    ("gru_rtrl", "rtrl", 64, 512),
    ("gru_rtrl", "rtrl", 128, 128),
    ("gru_rtrl", "rtrl", 256, 16),
    ("gru_rtrl", "snap1", 64, 2048),
    ("gru_rtrl", "snap1", 128, 2048),
    ("gru_rtrl", "snap1", 256, 1024),
    ("gru_rtrl", "snap1", 512, 512),
    ("gru_rtrl", "uoro", 64, 2048),
    ("gru_rtrl", "uoro", 128, 2048),
    ("gru_rtrl", "uoro", 256, 1024),
    ("gru_rtrl", "uoro", 512, 512),
