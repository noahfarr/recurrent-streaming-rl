...
algorithm supplies. Each recurrent layer supplies its
...
the same measurements attribute to phase cancellation, since minGRU's coherence is exactly $1$ at
...
$\lambda{=}0.995$, though sublinearly, with the ratio $L/(1-\gamma\lambda)^{-1}$ falls from $3.2$ to
...
$+0.14$ and $+0.25$, while the absolute reach differs by an order of magnitude, with stream
