...
from src.algorithms.eligibility_trace import broadcast
...
@dataclass
class OBGD:
    """Overshoot-Bounded Gradient Descent (Elsayed et al.) — streaming
    optimizer with adaptive step size keyed off the eligibility trace and the
    TD error.
    """
